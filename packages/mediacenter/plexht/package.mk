...
PKG_URL="https://github.com/plexinc/plex-home-theater-public/archive/$PKG_VERSION/plexht-$PKG_VERSION.tar.gz"
PKG_DEPENDS_TARGET="toolchain boost Python zlib bzip2 systemd pciutils lzo pcre swig:host libass enca curl rtmpdump fontconfig fribidi tinyxml libjpeg-turbo libpng tiff freetype jasper libogg libcdio libmodplug libmpeg2 taglib libxml2 libxslt yajl sqlite libvorbis ffmpeg libshairplay libsamplerate flac SDL_mixer lame"
...
post_makeinstall_target() {
  ...
  # Use plex splash
  cp -f ../plex/Resources/Splash.png $INSTALL/usr/share/XBMC/media/
